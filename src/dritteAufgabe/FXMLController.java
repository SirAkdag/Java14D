...
public class FXMLController {
    ...
    @FXML
    protected void mausGedrueckt(MouseEvent e) {
    ...
    @FXML
    protected void mausLos(MouseEvent e) {
        ...
        if (e.getButton() == MouseButton.PRIMARY) {
            ...
            // hier wurde neues Werkzeug für den gefüllten Kreis erstellt
            if (werkzeug ==4)
                circleFilled((int) (e.getX() - xPos), (int) (e.getY() - yPos));
        }
    }
    ...
    //Hier wird eine Methode für einen gefüllten Kreis mit den angegebenen Parametern erstellt.
    //und mit den Methoden setfill und fillOval wird das Innere des erzeugten Kreises-
    //mit der vom Benutzer ausgewählten Farbe gefüllt.
    protected void circleFilled(int breite, int hoehe) {
        gc.strokeOval(xPos, yPos, breite, hoehe);
        gc.setFill(farbe);
